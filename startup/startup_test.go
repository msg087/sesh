...
func TestExecSkipsDefaultWindow(t *testing.T) {
	...
	mockTmux.On("SendKeys", "JSR:api.0", "clear").Return("", nil)
	mockTmux.On("SendKeys", "JSR:ns.0", "echo ns").Return("", nil)
	mockTmux.On("SendKeys", "JSR:iac.0", "echo iac").Return("", nil)
	mockTmux.On("SelectPaneTarget", "JSR:api.0").Return("", nil)
	mockTmux.On("SelectPaneTarget", "JSR:ns.0").Return("", nil)
	mockTmux.On("SelectPaneTarget", "JSR:iac.0").Return("", nil)
